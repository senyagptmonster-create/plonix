...
class AppTheme {
  static const Color cBg = Color(0xFF0D0A14);
  static const Color cSurface = Color(0xFF171223);
  static const Color cEdge = Color(0xFF251D38);
  static const Color cAccent = Color(0xFFD946EF);
  static const Color cAccent2 = Color(0xFFF0ABFC);
  static const Color cInk = Color(0xFFFDF4FF);
